...
import 'package:AeroTaxi/core/repositories/faqs_repository/faqs_repository_impl.dart';
...
class FaqsController {
  final FaqsRepositoryImpl _faqsRepositoryImpl;

  FaqsController(this._faqsRepositoryImpl);
  ...
  Stream<QuerySnapshot>? getListDocuments() {
    return _faqsRepositoryImpl.getFaqs();
  }
